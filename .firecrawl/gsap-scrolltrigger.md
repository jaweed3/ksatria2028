[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#__docusaurus_skipToContent_fallback)
...
[Introducing ScrollTrigger for GSAP](https://www.youtube.com/watch?v=X7IBa7vZjmo) [GSAP Learning](https://www.youtube.com/channel/UCFPckx3BFK_GvJag82CjDlg)

![thumbnail-image](https://yt3.ggpht.com/VkvSe9upeTvrT_8t59qhlU5b9x5rbTFE2sGiVBZGogyFLnhxymZjdXsfDULpAq0Zk1bdJDh-Tg=s68-c-k-c0x00ffffff-no-rj)

GSAP Learning47.3K subscribers
...
- #### animation [Direct link to animation](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#animation)
...
- #### anticipatePin [Direct link to anticipatePin](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#anticipatePin)
...
- #### containerAnimation [Direct link to containerAnimation](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#containerAnimation)
...
- #### end [Direct link to end](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#end)
...
[Watch on Vimeo](https://vimeo.com/828003354?fl=pl&fe=vl)
...
- #### endTrigger [Direct link to endTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#endTrigger)
...
- #### fastScrollEnd [Direct link to fastScrollEnd](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#fastScrollEnd)
...
- #### horizontal [Direct link to horizontal](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#horizontal)
...
- #### id [Direct link to id](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#id)
...
- #### invalidateOnRefresh [Direct link to invalidateOnRefresh](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#invalidateOnRefresh)
...
- #### markers [Direct link to markers](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#markers)
...
- #### once [Direct link to once](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#once)
...
- #### onEnter [Direct link to onEnter](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onEnter)
...
- #### onEnterBack [Direct link to onEnterBack](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onEnterBack)
...
- #### onLeave [Direct link to onLeave](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onLeave)
...
- #### onLeaveBack [Direct link to onLeaveBack](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onLeaveBack)
...
- #### onRefresh [Direct link to onRefresh](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onRefresh)
...
- #### onUpdate [Direct link to onUpdate](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onUpdate)
...
- #### onScrubComplete [Direct link to onScrubComplete](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onScrubComplete)
...
- #### onSnapComplete [Direct link to onSnapComplete](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onSnapComplete)
...
- #### onToggle [Direct link to onToggle](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#onToggle)
...
- #### pin [Direct link to pin](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#pin)
...
- #### pinnedContainer [Direct link to pinnedContainer](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#pinnedContainer)
...
- #### pinReparent [Direct link to pinReparent](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#pinReparent)
...
- #### pinSpacer [Direct link to pinSpacer](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#pinSpacer)
...
- #### pinSpacing [Direct link to pinSpacing](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#pinSpacing)
...
- #### pinType [Direct link to pinType](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#pinType)
...
- #### preventOverlaps [Direct link to preventOverlaps](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#preventOverlaps)
...
- #### refreshPriority [Direct link to refreshPriority](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#refreshPriority)
...
- #### scroller [Direct link to scroller](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#scroller)
...
- #### scrub [Direct link to scrub](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#scrub)
...
- #### snap [Direct link to snap](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#snap)
...
- #### start [Direct link to start](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#start)
...
- #### toggleActions [Direct link to toggleActions](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#toggleActions)
...
- #### toggleClass [Direct link to toggleClass](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#toggleClass)
...
- #### trigger [Direct link to trigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/\#trigger)
...
- [Simple example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#simple-example)
- [Advanced example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#advanced-example)
- [Standalone/Custom example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#standalonecustom-example)
- [Features](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#features)
- [**Config Object**](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#config-object)
- [**Properties**](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#properties)
- [**Methods**](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#methods)
- [FAQs](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#faqs)
- [**Demos**](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#demos)